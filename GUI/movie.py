from guizero import App, Combo, CheckBox, Text, ButtonGroup, PushButton, info
...
seat_type = Text(app, text="Which seat type?", grid=[0,1], align="left")
vip_seat = CheckBox(app, text="VIP seat?", grid=[1,1], align="left")

seat_location = Text(app, text="Which seat type?", grid=[0,1], align="left")
